...
out_tensor_ty = np.ndarray[(tensor_size,), np.dtype[np.int32]]
out_tile_ty = np.ndarray[(tile_size,), np.dtype[np.int32]]

convert_fn = Kernel("float32_to_int32_q", "convert.o", [in_tile_ty, out_tile_ty, np.int32])
