...
in_tensor_ty = np.ndarray[(tensor_size,), np.dtype[np.int16]]
in_tile_ty = np.ndarray[(tile_size,), np.dtype[np.int16]]
...
convert_fn = Kernel("q15_to_bfloat16", "convert.o", [in_tile_ty, out_tile_ty, np.int32])
