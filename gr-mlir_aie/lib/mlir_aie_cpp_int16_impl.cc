...
#include "mlir_aie_cpp_int16_impl.h"
#include <gnuradio/io_signature.h>

namespace gr {
namespace mlir_aie {

mlir_aie_cpp_int16::sptr mlir_aie_cpp_int16::make(const char* path_xclbin,
                                                  const char* path_insts_bin,
                                                  const char* kernel_name,
                                                  int VECTOR_SIZE)
{
    return gnuradio::make_block_sptr<mlir_aie_cpp_int16_impl>(
 ...
 */
mlir_aie_cpp_int16_impl::mlir_aie_cpp_int16_impl(const char* path_xclbin,
                                                 const char* path_insts_bin,
                                                 const char* kernel_name,
                                                 int VECTOR_SIZE)
    : gr::block("mlir_aie_cpp_int16",
 ...
 */
mlir_aie_cpp_int16_impl::~mlir_aie_cpp_int16_impl() {}

void mlir_aie_cpp_int16_impl::forecast(int noutput_items,
                                       gr_vector_int& ninput_items_required)
{
    ninput_items_required[0] = noutput_items;
}

int mlir_aie_cpp_int16_impl::general_work(int noutput_items,
