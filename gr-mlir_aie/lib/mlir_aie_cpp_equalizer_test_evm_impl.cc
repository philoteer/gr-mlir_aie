...
mlir_aie_cpp_equalizer_test_evm::sptr mlir_aie_cpp_equalizer_test_evm::make()
{
    return gnuradio::make_block_sptr<mlir_aie_cpp_equalizer_test_evm_impl>();
}
...
int mlir_aie_cpp_equalizer_test_evm_impl::general_work(
    int noutput_items,
