...
using equalizer_evm_input_type = std::complex<float>;
using equalizer_evm_output_type = std::int8_t;
...
private:
    ...
    struct io_slot {
        ...
        equalizer_evm_output_type* output = nullptr;
...
public:
    mlir_aie_cpp_equalizer_test_evm_impl(const char* path_xclbin,
